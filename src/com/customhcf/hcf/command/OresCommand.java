...
public class OresCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String s, String[] args) {
        ...
        sender.sendMessage(ChatColor.LIGHT_PURPLE.toString() + ChatColor.BOLD + ChatColor.STRIKETHROUGH + "=========" + ChatColor.LIGHT_PURPLE +  " ORE STATS "+ ChatColor.LIGHT_PURPLE.toString() + ChatColor.BOLD + ChatColor.STRIKETHROUGH +"=========" );
        sender.sendMessage(ChatColor.GREEN + "Emerald Mined: " + ChatColor.GRAY + target.getStatistic(Statistic.MINE_BLOCK, Material.EMERALD_ORE));
        sender.sendMessage(ChatColor.AQUA + "Diamonds Mined: " + ChatColor.GRAY + target.getStatistic(Statistic.MINE_BLOCK, Material.DIAMOND_ORE));
        sender.sendMessage(ChatColor.GOLD + "Gold Mined: " + ChatColor.GRAY + target.getStatistic(Statistic.MINE_BLOCK, Material.GOLD_ORE));
        sender.sendMessage(ChatColor.RED + "Redstone Mined: " + ChatColor.GRAY + target.getStatistic(Statistic.MINE_BLOCK, Material.REDSTONE_ORE));
        sender.sendMessage(ChatColor.BLUE + "Lapis Mined: " + ChatColor.GRAY + target.getStatistic(Statistic.MINE_BLOCK, Material.LAPIS_ORE));
        sender.sendMessage(ChatColor.GRAY + "Iron Mined: " + ChatColor.GRAY + target.getStatistic(Statistic.MINE_BLOCK, Material.IRON_ORE));
        sender.sendMessage(ChatColor.DARK_GRAY + "Coal Mined: " + ChatColor.GRAY + target.getStatistic(Statistic.MINE_BLOCK, Material.COAL_ORE));
        return true;
    }
}
