package net.veilmc.hcf.events.argument;
...
import net.veilmc.hcf.events.palace.PalaceFaction;
import net.veilmc.hcf.events.palace.PalaceTracker;
import net.veilmc.hcf.events.tracker.ConquestTracker;
import net.veilmc.hcf.events.tracker.KothTracker;
